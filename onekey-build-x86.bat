...
set CommonOptions=-G "Ninja Multi-Config" -DCMAKE_CONFIGURATION_TYPES=Release -DWindowsTargetPlatformMinVersion=5.1.2600.0 -DYYTHUNKS_TARGET_OS=WinXP -DBUILD_SHARED_LIBS=ON -DQT_BUILD_EXAMPLES=OFF -DQT_BUILD_TESTS=OFF
